...
//add by rpdzkj for touch Goodix TP wakeup lcd	20181229
//Note: #define GTP_HAVE_TOUCH_KEY    1
#define RP_GTP_TOUCH_WAKEUP_LCD     0

#define RP_LCD_BL_EN_GPIO     226
//end
...
#define GTP_I2C_NAME                "Goodix-TS-GT9X"
